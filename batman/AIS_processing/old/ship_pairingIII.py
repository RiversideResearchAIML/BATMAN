...
for _, df_ in df_stats.groupby( ['threshold_sec', 'threshold_m','clustering_eps_m']):
    df_compare.append( df_.loc[df_['max_perm'] == 1E6, ['file', 'mean success pairing', 'mean interval m', 'greedy count', 'max greedy count', 'clustering_eps_m', 'threshold_sec', 'threshold_m']].reset_index(drop=True).join(
        df_.loc[df_['max_perm'] == 1, ['file', 'mean success pairing', 'mean interval m', 'max greedy count']].reset_index(drop=True),
          lsuffix='_1E6', rsuffix='_1') )
df_compare = pd.concat( df_compare, axis = 0 )
df_compare['improved success pairing'] = df_compare['mean success pairing_1'] < df_compare['mean success pairing_1E6']
df_compare['improved distance pairing'] = df_compare['mean interval m_1'] > df_compare['mean interval m_1E6']
...
df_compare = df_compare.sort_values(['improved success pairing', 'improved distance pairing','successful pairing_1E6',
...
df_compare[['improved success pairing', 'improved distance pairing', 'successful pairing_1E6',
                 'successful pairing_1', 'mean interval m_1E6', 'mean interval m_1', 'clustering_eps_m', 'threshold_sec', 'threshold_m', 'greedy count', 'max greedy count_1E6']]
##
colors = list('rcg')
